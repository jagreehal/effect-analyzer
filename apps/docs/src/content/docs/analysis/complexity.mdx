...
```ts
import { analyze, calculateComplexity } from "effect-analyzer/analysis"
...
```ts
import { calculateComplexity, assessComplexity } from "effect-analyzer/analysis"
...
```ts
import { calculateComplexity, formatComplexitySummary } from "effect-analyzer/analysis"
