...
- **Source linting** — 15 deterministic rules with [docs links and Bad → Good examples](/effect-analyzer/project/source-linter/), SARIF 2.1 output, baseline + `--fail-on-new` CI gating
