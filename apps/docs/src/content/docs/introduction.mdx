...
- **Source linting** — 18 deterministic rules with [docs links and Bad → Good examples](/effect-analyzer/project/source-linter/), SARIF 2.1 output, baseline + `--fail-on-new` CI gating
- **Health analyzers** — [error channel](/effect-analyzer/project/health/#error-channel), [service dependency health](/effect-analyzer/project/health/#service-health), and [performance anti-patterns](/effect-analyzer/project/health/#performance) across an entire project
- **App-shape analyzers** — [entry points](/effect-analyzer/project/app-shape/#entry-points), [config-secret leak detection](/effect-analyzer/project/app-shape/#config-leaks), [`@effect/cli` command structure](/effect-analyzer/project/app-shape/#cli-commands), [service cycles](/effect-analyzer/project/app-shape/#service-cycles)
- **Improvement workflow** — [`--agent-report`](/effect-analyzer/project/improve/) emits a prioritized backlog optimized for coding agents; [`--improve`](/effect-analyzer/project/improve/#auto-fix) applies safe auto-fixes for fixable lint findings
- **Project tools** — [coverage audits](/effect-analyzer/project/coverage-audit/), [semantic diffs](/effect-analyzer/project/diff/), [migration assistant](/effect-analyzer/project/migration/), [strict diagnostics](/effect-analyzer/project/diagnostics/)
