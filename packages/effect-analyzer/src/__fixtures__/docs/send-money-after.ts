...
export class FraudRiskError {
  readonly _tag = 'FraudRiskError';
  constructor(readonly reason: string) {}
}
...
export class FraudScreening extends Context.Tag('FraudScreening')<
  FraudScreening,
  {
    readonly screen: (
      input: TransferRequest,
    ) => Effect.Effect<void, FraudRiskError>;
  }
>() {}
