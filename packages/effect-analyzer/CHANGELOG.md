...
- bc1f1f8: The error flow diagram now shows what each handler does to each error. Edges
...
- 488145f: `--version`/`-v` prints the analyzer version, and an unrecognized flag is
...
- a1cd3ea: `effect-analyze` is now a drop-in replacement for the `effect-tsgo` CLI.
